odoo.define('hb_pos_cash.CashMoveButton', function (require) {
    'use strict';
    ...
    class CashMoveButton extends PosComponent {
        ...
        async onClick() {
            ...
            if (!amount) {
                return this.hbShowNotification(
            ...
            if (this.env.pos.proxy.printer) {
                const renderedReceipt = this.env.qweb.renderToString('hb_pos_cash.CashMoveReceipt', {
    ...
    CashMoveButton.template = 'hb_pos_cash.CashMoveButton';
